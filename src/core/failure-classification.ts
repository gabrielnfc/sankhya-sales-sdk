 ...
 *
 * 401/403 sao credencial; 429 e 5xx sao indisponibilidade (desfecho desconhecido);
 * o restante do 4xx e recusa de negocio. Status ausente cai em `TIMEOUT`.
 */
function classifyHttpStatus(statusCode: number | undefined): SankhyaFailureKind {
  ...
  if (statusCode === HTTP_TOO_MANY_REQUESTS) return 'TIMEOUT';
